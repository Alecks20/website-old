...
- Implemented sophisticated monitoring and alerting systems with [hetrixtools](https://hetrixtools.com) (previously using uptime kuma, but lacks heartbeat monitoring or resource monitor) to monitor uptime, resource usage and self-hosted [ntfy](https://ntfy.sh) to get mobile notifications.
